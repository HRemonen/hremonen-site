...
export const MoonIcon = () => (
  <svg
    aria-hidden='true'
    tabIndex={-1}
    className='group fill-current transition duration-500 ease-in-out hover:rotate-12'
...
export const SunIcon = () => (
  <svg
    aria-hidden='true'
    tabIndex={-1}
    className='group transition-colors ease-in-out hover:fill-yellow-300 hover:text-yellow-400'
    xmlns='http://www.w3.org/2000/svg'
    viewBox='0 0 24 24'
    strokeWidth='1.5'
    fill='none'

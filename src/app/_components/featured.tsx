    ...
    <section className='mx-auto mb-16 max-w-5xl'>
      ...
      >
        ...
        >
          ...
          />
          <div className='duration-600 absolute bottom-0 left-[380px] z-10 flex flex-col transition-all ease-in-out'>
            <h2 className='duration-600 relative flex h-[420px] translate-y-0 transform items-center justify-center text-6xl transition-all ease-in-out group-hover:-translate-y-full'>
              {title}
            </h2>
